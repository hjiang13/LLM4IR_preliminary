module {
  ...
  ^bb20:  // pred: ^bb19
    ...
    %98 = llvm.fsub %81, %97 : f32
    %99 = llvm.extractvalue %11[1] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %100 = llvm.extractvalue %11[2] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %101 = llvm.getelementptr %99[%100] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %102 = llvm.extractvalue %11[4, 0] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %103 = llvm.mul %58, %102 : i64
    %104 = llvm.extractvalue %11[4, 1] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %105 = llvm.mul %60, %104 : i64
    %106 = llvm.add %103, %105 : i64
    %107 = llvm.extractvalue %11[4, 2] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %108 = llvm.mul %62, %107 : i64
    %109 = llvm.add %106, %108 : i64
    %110 = llvm.extractvalue %11[4, 3] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %111 = llvm.mul %64, %110 : i64
    %112 = llvm.add %109, %111 : i64
    %113 = llvm.getelementptr %101[%112] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %98, %113 : f32, !llvm.ptr
    %114 = llvm.add %64, %13 : i64
    llvm.br ^bb19(%114 : i64)
  ^bb21:  // pred: ^bb19
    %115 = llvm.add %62, %13 : i64
    llvm.br ^bb17(%115 : i64)
  ^bb22:  // pred: ^bb17
    %116 = llvm.add %60, %13 : i64
    llvm.br ^bb15(%116 : i64)
  ^bb23:  // pred: ^bb15
    %117 = llvm.add %58, %13 : i64
