...
94:                                               ; preds = %91
  ...
  %111 = fmul float %110, -1.000000e+00
  %112 = call float @llvm.exp.f32(float %111)
  %113 = fadd float %112, 1.000000e+00
  %114 = fdiv float 1.000000e+00, %113
  %115 = extractvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %22, 1
  %116 = extractvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %22, 2
  %117 = getelementptr float, ptr %115, i64 %116
  %118 = extractvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %22, 4, 0
  %119 = mul i64 %80, %118
  %120 = extractvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %22, 4, 1
  %121 = mul i64 %84, %120
  %122 = add i64 %119, %121
  %123 = extractvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %22, 4, 2
  %124 = mul i64 %88, %123
  %125 = add i64 %122, %124
  %126 = extractvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %22, 4, 3
  %127 = mul i64 %92, %126
  %128 = add i64 %125, %127
  %129 = getelementptr float, ptr %117, i64 %128
  store float %114, ptr %129, align 4
  %130 = add i64 %92, 1
  br label %91
