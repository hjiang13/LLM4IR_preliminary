module {
  ...
  ^bb20:  // pred: ^bb19
    ...
    %82 = llvm.intr.sqrt(%81) : (f32) -> f32
    %83 = llvm.extractvalue %11[1] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %84 = llvm.extractvalue %11[2] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %85 = llvm.getelementptr %83[%84] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %86 = llvm.extractvalue %11[4, 0] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %87 = llvm.mul %58, %86 : i64
    %88 = llvm.extractvalue %11[4, 1] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %89 = llvm.mul %60, %88 : i64
    %90 = llvm.add %87, %89 : i64
    %91 = llvm.extractvalue %11[4, 2] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %92 = llvm.mul %62, %91 : i64
    %93 = llvm.add %90, %92 : i64
    %94 = llvm.extractvalue %11[4, 3] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %95 = llvm.mul %64, %94 : i64
    %96 = llvm.add %93, %95 : i64
    %97 = llvm.getelementptr %85[%96] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %82, %97 : f32, !llvm.ptr
    %98 = llvm.add %64, %13 : i64
    llvm.br ^bb19(%98 : i64)
  ^bb21:  // pred: ^bb19
    %99 = llvm.add %62, %13 : i64
    llvm.br ^bb17(%99 : i64)
  ^bb22:  // pred: ^bb17
    %100 = llvm.add %60, %13 : i64
    llvm.br ^bb15(%100 : i64)
  ^bb23:  // pred: ^bb15
    %101 = llvm.add %58, %13 : i64
    llvm.br ^bb13(%101 : i64)
  ^bb24:  // pred: ^bb13
