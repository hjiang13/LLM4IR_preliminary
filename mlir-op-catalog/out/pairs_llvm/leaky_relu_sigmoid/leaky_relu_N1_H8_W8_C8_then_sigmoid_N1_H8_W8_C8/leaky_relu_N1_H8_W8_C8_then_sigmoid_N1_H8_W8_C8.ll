...
93:                                               ; preds = %90
  ...
  %110 = fmul float %109, -1.000000e+00
  %111 = call float @llvm.exp.f32(float %110)
  %112 = fadd float %111, 1.000000e+00
  %113 = fdiv float 1.000000e+00, %112
  %114 = extractvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %22, 1
  %115 = extractvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %22, 2
  %116 = getelementptr float, ptr %114, i64 %115
  %117 = extractvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %22, 4, 0
  %118 = mul i64 %79, %117
  %119 = extractvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %22, 4, 1
  %120 = mul i64 %83, %119
  %121 = add i64 %118, %120
  %122 = extractvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %22, 4, 2
  %123 = mul i64 %87, %122
  %124 = add i64 %121, %123
  %125 = extractvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %22, 4, 3
  %126 = mul i64 %91, %125
  %127 = add i64 %124, %126
  %128 = getelementptr float, ptr %116, i64 %127
  store float %113, ptr %128, align 4
  %129 = add i64 %91, 1
  br label %90
