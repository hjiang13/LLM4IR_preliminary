module {
  ...
  ^bb20:  // pred: ^bb19
    ...
    llvm.store %84, %99 : f32, !llvm.ptr
    %100 = llvm.add %66, %14 : i64
    llvm.br ^bb19(%100 : i64)
  ^bb21:  // pred: ^bb19
    %101 = llvm.add %64, %14 : i64
    llvm.br ^bb17(%101 : i64)
  ^bb22:  // pred: ^bb17
    %102 = llvm.add %62, %14 : i64
    llvm.br ^bb15(%102 : i64)
  ^bb23:  // pred: ^bb15
    %103 = llvm.add %60, %14 : i64
