module {
  ...
  ^bb8:  // pred: ^bb7
    ...
    %59 = llvm.extractvalue %11[2] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %60 = llvm.getelementptr %58[%59] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %61 = llvm.extractvalue %11[4, 0] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %62 = llvm.mul %50, %61 : i64
    %63 = llvm.extractvalue %11[4, 1] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %64 = llvm.mul %52, %63 : i64
    %65 = llvm.add %62, %64 : i64
    %66 = llvm.extractvalue %11[4, 2] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %67 = llvm.mul %54, %66 : i64
    %68 = llvm.add %65, %67 : i64
    %69 = llvm.extractvalue %11[4, 3] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %70 = llvm.mul %56, %69 : i64
    %71 = llvm.add %68, %70 : i64
    %72 = llvm.getelementptr %60[%71] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %73 = llvm.load %72 : !llvm.ptr -> f32
    %74 = llvm.intr.maximum(%73, %15) : (f32, f32) -> f32
    %75 = llvm.extractvalue %49[1] : !llvm.struct<(ptr, ptr, i64, array<4 x i64>, array<4 x i64>)> 
    %76 = llvm.mlir.constant(512 : index) : i64
    %77 = llvm.mul %50, %76 : i64
    %78 = llvm.mlir.constant(64 : index) : i64
    %79 = llvm.mul %52, %78 : i64
    %80 = llvm.add %77, %79 : i64
    %81 = llvm.mlir.constant(8 : index) : i64
    %82 = llvm.mul %54, %81 : i64
    %83 = llvm.add %80, %82 : i64
    %84 = llvm.add %83, %56 : i64
    %85 = llvm.getelementptr %75[%84] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %74, %85 : f32, !llvm.ptr
    %86 = llvm.add %56, %13 : i64
    llvm.br ^bb7(%86 : i64)
  ^bb9:  // pred: ^bb7
    %87 = llvm.add %54, %13 : i64
    llvm.br ^bb5(%87 : i64)
  ^bb10:  // pred: ^bb5
    %88 = llvm.add %52, %13 : i64
    llvm.br ^bb3(%88 : i64)
  ^bb11:  // pred: ^bb3
    %89 = llvm.add %50, %13 : i64
    llvm.br ^bb1(%89 : i64)
  ^bb12:  // pred: ^bb1
